...
After my initial exploration of the data I discovered some interesting trends I didn't expect and want to look closer. Namely that while obesity is increasing, we are appearing to consume the same amount of calories. With that said this project transitioned into what factors influence obesity and now more specifically waist sizes increasing over time. Over this semester I aimed get more data into the file and properly clean it, in addition to completing a PCA of the data as well as other possible regressions.
